...
/home/rtiwari1/compiler/$1/host/linux-x86/bin/dx --dex "$flag2" "$flag3" classes
filejar="$filen.jar"
zip  $filejar $filedex
export ANDROID_ROOT=/home/rtiwari1/compiler/$1/host/linux-x86
export ANDROID_DATA=/home/rtiwari1/compiler
...
/home/rtiwari1/compiler/$1/host/linux-x86/bin/dex2oatd "$flag5" --runtime-arg -Xnorelocate "$flag7" "$flag8" "$flag9" "$flag10" "$flag11" "$flag12"

/home/rtiwari1/compiler/$1/host/linux-x86/bin/oatdump "$flag14" >out.txt
